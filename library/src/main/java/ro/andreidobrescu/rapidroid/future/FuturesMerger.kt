...
import ro.andreidobrescu.rapidroid.*
...
{
    @JvmStatic
    fun <T, Q> merge(firstFuture : Future<T?>, secondFuture : Future<Q?>) : Future<Pair<T?, Q?>> = Run.async {
        ...
        return@async Pair(firstFutureResult.get(), secondFutureResult.get())
    }
}
