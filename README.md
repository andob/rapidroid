...
```
dependencies {
    implementation 'ro.andob.rapidroid:rapidroid-api:1.4.1'
    implementation 'ro.andob.rapidroid:rapidroid-core:1.4.1'
    implementation 'ro.andob.rapidroid:rapidroid-futures:1.4.1'
    implementation 'ro.andob.rapidroid:rapidroid-workflow:1.4.1'
    implementation 'ro.andob.rapidroid:rapidroid-actor:1.4.1'
}
```
